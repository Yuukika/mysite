...
def article_list(request,username=None):
    ...
    try:
        ...
        articles = current_page.object_list
    if username:
        return render(request, 'article/list/author_article.html', {'article_list': articles, 'page':current_page,'user':user,'userinfo':userinfo})
    else:
        return render(request, 'article/list/article_list.html', {'article_list': articles, 'page':current_page})
